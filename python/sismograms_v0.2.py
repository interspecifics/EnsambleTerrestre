...
def draw_sismogram(track):
	# -- canvas
	# colors: http://paletton.com/#uid=7261u0kllll2H1Ec1bwuEvaS+W4
	val = 3.14
	tim = "-24:66:14"
	lud = "24/4/1420"
	colors = {'white':[202, 177, 166], 'dark': [59, 49, 39], \
				'blue':[161, 91, 18], 'yellow': [0, 254, 213], \
				'orange':[0, 151, 255], 'pink': [241,0,233]}
	...
	for a in range(4):
		for b in range(132):
			...
			if indek<4*132-1:
				...
				cv2.rectangle(nu_can, (40 + 3*b, -50+h/4), (40 + 3*b +20, 50+h/4),  colors['dark'], cv2.FILLED)
				...
				cv2.rectangle(nu_can, (250, 30+h/2),  (450, 5+h/2),  colors['dark'], cv2.FILLED)
				cv2.rectangle(nu_can, (250, 60+h/2),  (450, 30+h/2), colors['dark'], cv2.FILLED)
				cv2.rectangle(nu_can, (250, 90+h/2),  (450, 60+h/2), colors['dark'], cv2.FILLED)
				cv2.rectangle(nu_can, (180, 125+h/2), (450, 100+h/2), colors['dark'], cv2.FILLED)
